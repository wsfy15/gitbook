...
* 第二步，**衡量和其他用户或者物品之间的相似度**，这里的物品就是电影。
  ...
  ![1580302441757](../.gitbook/assets/1580302441757.png)

  物品之间相似度 的公式：

  ![1580302458097](../.gitbook/assets/1580302458097.png)
...
![1580304000996](../.gitbook/assets/1580304000996.png)

\($us$就是公式中分母应为平方和开根号，而不是对和开根号\)

* 第三步，**根据相似的用户或物品，给出预测的得分 p**。

  ![1580302659950](../.gitbook/assets/1580302659950.png)

  通过第二步得到用户相似度矩阵$US$ ，$US$ 和评分矩阵$X$ 的点乘结果为矩阵$USP$ 。沿用前面的示例，结果就是下面这样。 ![1580305139160](../.gitbook/assets/1580305139160.png)

  归一化：对$USP$ 按行求和，获得矩阵$USR$ ，然后使用$USP$ 和$USR$ 的元素对应除法，就可以求得任意用户对任意电影的评分矩阵

  ![1580305165120](../.gitbook/assets/1580305165120.png)

![1580305487715](../.gitbook/assets/1580305487715.png)

...
![img](gai-lv-he-tong-ji.assets/e0f92302ec5f9a7353177644db88a408.png)
...
![img](gai-lv-he-tong-ji.assets/504f97b994046fc3fee82690acdd5622.png)
...
![img](gai-lv-he-tong-ji.assets/83baf008f9888a6afb6ec5720270aaf3.png)
...
![img](gai-lv-he-tong-ji.assets/24420c243fe5c2f439654596be6f2c8d.png)
...
任何一个词$w_{i}$出现的概率只和它前面的1个或若干个词有关。
...
假设我们有一个统计样本文本$d$，$s$表示某个有意义的句子，由一连串按照特定顺序排列的词$w_{1}，w_{2},…,w_{n}$组成，这里$n$是句子里单词的数量。
...
计算$P(w_{1}, w_{2}, …, w_{n})$，要在集合中找到一模一样的句子，基本是不可能的。这个时候，就需要使用链式法则把这个式子改写为：

![img](gai-lv-he-tong-ji.assets/2fe51ac1be8efbad2082627860aada23.png)

但是上式$P(w_{3}|w_{1},w_{2})$出现概率很低，$P(w_{4}|w_{1},w_{2},w_{3})$出现的概率就更低了。一直到$P(w_{n}|w_{1}, w_{2}, …, w_{n-1})$，基本上又为0了。

$P(w_{1}, w_{2}, …, w_{n})和P(w_{n}|w_{1}, w_{2}, …, w_{n-1})$不只会导致0概率，它还会使得模型存储空间的急速增加。

如果我们**使用三元文法模型**，上述公式可以改写为：

![img](gai-lv-he-tong-ji.assets/6dfe1f3c267787677090a611fee964b1.png)
